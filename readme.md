<div align=center>
<img src="https://github.com/MrAkshay143/Fooocus/assets/19834515/483fb86d-c9a2-4c20-997c-46dafc124f25">
...
See also **non-cherry-picked** generalization and diversity tests [here](https://github.com/MrAkshay143/Fooocus/discussions/808) and [here](https://github.com/MrAkshay143/Fooocus/discussions/679) and [here](https://github.com/MrAkshay143/Fooocus/discussions/679#realistic).
...
| --niji | [Multiple launchers: "run.bat", "run_anime.bat", and "run_realistic.bat".](https://github.com/MrAkshay143/Fooocus/discussions/679) <br> Fooocus support SDXL models on Civitai <br> (You can google search “Civitai” if you do not know about it) |
...
Fooocus also developed many "fooocus-only" features for advanced users to get perfect results. [Click here to browse the advanced features.](https://github.com/MrAkshay143/Fooocus/discussions/117)
...
**[>>> Click here to download <<<](https://github.com/MrAkshay143/Fooocus/releases/download/release/Fooocus_win64_2-1-831.7z)**

After you download the file, please uncompress it and then run the "run.bat".

![image](https://github.com/MrAkshay143/Fooocus/assets/19834515/c49269c4-c274-4893-b368-047c401cc58c)
...
2. Note that if you use inpaint, at the first time you inpaint an image, it will download [Fooocus's own inpaint control model from here](https://huggingface.co/MrAkshay143/fooocus_inpaint/resolve/main/inpaint_v26.fooocus.patch) as the file "Fooocus\models\inpaint\inpaint_v26.fooocus.patch" (the size of this file is 1.28GB).

After Fooocus 2.1.60, you will also have `run_anime.bat` and `run_realistic.bat`. They are different model presets (and require different models, but they will be automatically downloaded). [Check here for more details](https://github.com/MrAkshay143/Fooocus/discussions/679).

![image](https://github.com/MrAkshay143/Fooocus/assets/19834515/d386f817-4bd7-490c-ad89-c1e228c23447)
...
![image](https://github.com/MrAkshay143/Fooocus/assets/19834515/938737a5-b105-4f19-b051-81356cb7c495)
...
![image](https://github.com/MrAkshay143/Fooocus/assets/19834515/2a06b130-fe9b-4504-94f1-2763be4476e9)
...
| Colab | Info
| --- | --- |
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MrAkshay143/Fooocus/blob/main/fooocus_colab.ipynb) | Fooocus Official
...
If you want to use Anaconda/Miniconda, you can
    ...
    git clone https://github.com/MrAkshay143/Fooocus.git
    cd Fooocus
...
Mac is not intensively tested. Below is an unofficial guideline for using Mac. You can discuss problems [here](https://github.com/MrAkshay143/Fooocus/pull/129).
...
1. Open the macOS Terminal app and clone this repository with `git clone https://github.com/MrAkshay143/Fooocus.git`.
...
See the guidelines [here](https://github.com/MrAkshay143/Fooocus/discussions/1405).
...
| --- | --- | --- | --- | --- | --- |
| General | run.bat |  | [juggernautXL v6_RunDiffusion](https://huggingface.co/MrAkshay143/fav_models/resolve/main/fav/juggernautXL_version6Rundiffusion.safetensors) | not used | [here](https://github.com/MrAkshay143/Fooocus/blob/main/modules/path.py) |
| Realistic | run_realistic.bat | --preset realistic | [realistic_stock_photo](https://huggingface.co/MrAkshay143/fav_models/resolve/main/fav/realisticStockPhoto_v10.safetensors) | not used | [here](https://github.com/MrAkshay143/Fooocus/blob/main/presets/realistic.json) |
| Anime | run_anime.bat | --preset anime | [bluepencil_v50](https://huggingface.co/MrAkshay143/fav_models/resolve/main/fav/bluePencilXL_v050.safetensors) | [dreamsharper_v8](https://huggingface.co/MrAkshay143/fav_models/resolve/main/fav/DreamShaper_8_pruned.safetensors) (SD1.5) | [here](https://github.com/MrAkshay143/Fooocus/blob/main/presets/anime.json) |
...
1. GPT2-based [prompt expansion as a dynamic style "Fooocus V2".](https://github.com/MrAkshay143/Fooocus/discussions/117#raw) (similar to Midjourney's hidden pre-processsing and "raw" mode, or the LeonardoAI's Prompt Magic).
...
4. We implemented a carefully tuned variation of Section 5.1 of ["Improving Sample Quality of Diffusion Models Using Self-Attention Guidance"](https://arxiv.org/pdf/2210.00939.pdf). The weight is set to very low, but this is Fooocus's final guarantee to make sure that the XL will never yield an overly smooth or plastic appearance (examples [here](https://github.com/MrAkshay143/Fooocus/discussions/117#sharpness)). This can almost eliminate all cases for which XL still occasionally produces overly smooth results, even with negative ADM guidance. (Update 2023 Aug 18, the Gaussian kernel of SAG is changed to an anisotropic kernel for better structure preservation and fewer artifacts.)
...
[Click here to browse the advanced features.](https://github.com/MrAkshay143/Fooocus/discussions/117)
...
See also [About Forking and Promotion of Forks](https://github.com/MrAkshay143/Fooocus/discussions/699).
